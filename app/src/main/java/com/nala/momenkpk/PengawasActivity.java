...
public class PengawasActivity extends AppCompatActivity implements MainAdapter.FirebaseDataListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabaseReference.child("data_instrumen-pengawas").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                mAdapter = new MainAdapter(PengawasActivity.this, daftarBarang);
            ...
            public void onCancelled(DatabaseError databaseError) {
                ...
                Toast.makeText(PengawasActivity.this,
