...
public class GuruActivity extends AppCompatActivity implements MainAdapter.FirebaseDataListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabaseReference.child("data_instrumen-guru").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                mAdapter = new MainAdapter(GuruActivity.this, daftarBarang);
            ...
            public void onCancelled(DatabaseError databaseError) {
                ...
                Toast.makeText(GuruActivity.this,
