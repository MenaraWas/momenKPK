...
public class KepsekActivity extends AppCompatActivity implements MainAdapter.FirebaseDataListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ui_kepsek);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                tvNilai.setText("ok");
                tvNilai.setTextColor(rgb(255,0,0));
        ...
        mDatabaseReference.child("data_instrumen-kepsek").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                mAdapter = new MainAdapter(KepsekActivity.this, daftarBarang);
            ...
            public void onCancelled(DatabaseError databaseError) {
                ...
                Toast.makeText(KepsekActivity.this,
